          ...
          <div className="disclaimer_rf">
            <div className="disclaimer_textrf">
              <p>
                ...
                action rather than words. So we’d like to share with you,
                Project Lighthouse, a groundbreaking initiative launching in the
                United States to uncover, measure, and overcome discrimination
                when booking or hosting on Bestfriend Treehouse.
              </p>
            </div>
          </div>
        </div>
