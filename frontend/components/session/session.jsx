            ...
            return (
                <>
                    ...
                    <form className='signup_form body' onSubmit={this.handleSubmit}>
                        <div className={this.state.nameError ? 'divNerror' : 's_first_name' }>
                            <input type = "text"  className="s_f"
                                value = { this.state.fname }
                                placeholder='First Name'
                                onChange = { this.update('fname') } />
                        </div>
                        <div className={this.state.nameError ? ' divLerror' : 's_last_name' }>
                ...
                <>
                    ...
                    <div className='login_form'>
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div className={this.state.passwordError ? 'diverror' :'l_password'}>
